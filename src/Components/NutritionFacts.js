	...
	return (
		<section className="performance-facts">
			<header className="performance-facts__header">
				...
				<p>{data.text ? data.text : "loading..."}</p>
			</header>
					...
					<tr>
						...
						<td>
							<b>
								{data.totalDaily
									? data.totalDaily.FAT
										? data.totalDaily.FAT.quantity.toPrecision(
												3
						...
						<th>
							...
							{data.totalNutrients
								? data.totalNutrients.FASAT
									? data.totalNutrients.FASAT.quantity.toPrecision(
											3
							...
							<b>
								{data.totalDaily
									? data.totalDaily.FASAT
										? data.totalDaily.FASAT.quantity.toPrecision(
												3
						...
						<th colSpan="2">
							...
							{data.totalNutrients
								? data.totalNutrients.CHOLE
									? data.totalNutrients.CHOLE.quantity.toPrecision(
											3
							...
							<b>
								{data.totalDaily
									? data.totalDaily.CHOLE
										? data.totalDaily.CHOLE.quantity.toPrecision(
												3
					...
					<tr>
						<th colSpan="2">
							...
							{data.totalNutrients
								? data.totalNutrients.NA
									? data.totalNutrients.NA.quantity.toPrecision(
											5
						...
						<td>
							<b>
								{data.totalDaily
									? data.totalDaily.NA
										? data.totalDaily.NA.quantity.toPrecision(
												3
						...
						<th colSpan="2">
							...
							{data.totalNutrients
								? data.totalNutrients.CHOCDF
									? data.totalNutrients.CHOCDF.quantity.toPrecision(
											4
							...
							<b>
								{data.totalNutrients
									? data.totalDaily.CHOCDF
										? data.totalDaily.CHOCDF.quantity.toPrecision(
												3
						...
						<th>
							...
							{data.totalNutrients
								? data.totalNutrients.FIBTG
									? data.totalNutrients.FIBTG.quantity.toPrecision(
											3
							...
							<b>
								{data.totalNutrients
									? data.totalDaily.FIBTG
										? data.totalDaily.FIBTG.quantity.toPrecision(
												3
						...
						<th>
							...
							{data.totalNutrients
								? data.totalNutrients.SUGAR
									? data.totalNutrients.SUGAR.quantity.toPrecision(
											4
						...
						<th colSpan="2">
							...
							{data.totalNutrients
								? data.totalNutrients.PROCNT
									? data.totalNutrients.PROCNT.quantity.toPrecision(
											3
						...
						<td>
							...
							{data.totalNutrients
								? data.totalNutrients.VITD
									? data.totalNutrients.VITD.quantity.toPrecision(
											3
						...
						<td>
							...
							{data.totalNutrients
								? data.totalNutrients.CA
									? data.totalNutrients.CA.quantity.toPrecision(
											3
						...
						<td>
							...
							{data.totalNutrients
								? data.totalNutrients.FE
									? data.totalNutrients.FE.quantity.toPrecision(
											3
						...
						<td>
							...
							{data.totalNutrients
								? data.totalNutrients.K
									? data.totalNutrients.K.quantity.toPrecision(
											3
